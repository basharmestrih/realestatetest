...
import 'package:my_house_app/app/modules/dashboard/NestedPages/ListingHome/views/widgets/listing_card.dart';
...
class ListingView extends StatefulWidget {
  @override
  State<ListingView> createState() => _PropertyViewState();
}

class _PropertyViewState extends State<ListingView> {
  int selectedIndex = 0;
...
Widget build(BuildContext context) {
  return Scaffold(
    ...
    children: [
      Text ('تصفح العقارات في قاعدة البيانات')
