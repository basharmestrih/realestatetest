              ...
              child: Padding(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    mainAxisAlignment: MainAxisAlignment.center,
                    children: [
                      const Text('EN', style: TextStyle(fontSize: 16,color:Colors.black)),
                      ...
                      Row(
                        ...
                        children: [
                          ...
                          const SizedBox(width: 8),
                      const Text('AR', style: TextStyle(fontSize: 16,color:Colors.black)),
                        ],
                      ),
                    ],
                  ),
                          ...
                          children: [
                            ...
                            Obx(() => Container(
                                  ...
                                  child: ResponsiveButton(
                                    ...
                                    child: Text('buttons_login'.tr, style: Theme.of(context).textTheme.titleMedium!.copyWith(color: AppColors.secondary
                                    ,fontSize: 13.r)),
                                  ),
                                )),
                            ...
                            Container(
                              ...
                              child: ResponsiveButton(
                                ...
                                buttonWidth: Get.width,
                                child: Text('guest_button'.tr, style: Theme.of(context).textTheme.titleMedium!.copyWith(color: AppColors.secondary,
                                fontSize: 13.r)),
                              ),
                            ),
